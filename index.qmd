...
Esta versión cubre el primer tramo conceptual del manual: datos y muestreo; estadística descriptiva; probabilidad; distribución muestral e intervalos de confianza; distribución $t$ de Student y pruebas de hipótesis; errores tipo I y II, potencia y tamaño de efecto; muestras apareadas; comparación de varianzas mediante la distribución $F$; análisis de frecuencias categóricas mediante $\chi^2$ de independencia; y una síntesis integradora del recorrido desde el dato hasta la inferencia.
...
Los capítulos espaciales —variable regionalizada, variograma y kriging— se incorporarán progresivamente a medida que avance el desarrollo del manual.
