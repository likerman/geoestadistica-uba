...
Esta versión cubre el tramo de la materia desarrollado hasta la **clase 7**: datos y muestreo; estadística descriptiva; probabilidad; distribución muestral e intervalos de confianza; distribución $t$ de Student y pruebas de hipótesis; errores tipo I y II, potencia y tamaño de efecto; muestras apareadas; comparación de varianzas mediante la distribución $F$; y análisis de frecuencias categóricas mediante $\chi^2$ de independencia.
