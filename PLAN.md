...
Este archivo mantiene la correspondencia entre el desarrollo del curso y el libro. Debe actualizarse cuando cambia la presentación fuente o se incorpora un capítulo.

## Estados

- `borrador`: estructura o notas iniciales.
- `en desarrollo`: texto sustantivo, todavía incompleto.
- `revisión docente`: contenido completo pendiente de revisión.
- `estable`: alineado con la versión vigente de la materia.

| Parte | Contenido del curso | Capítulo | Estado |
|---|---|---|---|
| Introducción | estadística, geoestadística, contexto, escala, incertidumbre | 01 | revisión docente |
| Introducción | población, muestra, parámetro, estadístico, muestreo | 02 | revisión docente |
| Introducción | variables, calidad, soporte y preparación | 03 | revisión docente |
| Descriptiva | frecuencias, histogramas, densidad, ECDF, KDE | 04 | revisión docente |
...
La diapositiva 127 anuncia 50 pozos, pero su tabla contiene 49 identificadores y 49 concentraciones. Los estadísticos de la diapositiva 128 son compatibles con agregar una concentración de 16,37 µg/L. No se publicará el conjunto hasta confirmar el identificador faltante y su procedencia.
